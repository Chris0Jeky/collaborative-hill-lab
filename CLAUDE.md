...
|---|---|---|
| anything | `make check` (ruff + `mypy --strict` + unit/property); unsure → `make test`, the whole suite | check clean, 39 files, 106 passed ~5s; suite 125 passed (82 unit + 24 property + 9 metamorphic + 10 integration) in 7s |
